...
> 部分安装包超过 100MB，请到 [GitHub Releases](https://github.com/BugNote/bug-file-renamer/releases) 下载。
...
| Windows |         x64         | `.exe` 安装包 + 便携版 |
| Windows |     x86 (32 位)     | `.exe` 安装包 + 便携版 |
|  Linux  |         x64         |      `.AppImage`       |
|  Linux  |         ARM         |      `.AppImage`       |
...
|   场景   |           修改前           |           修改后           |
| :-----: | :-----------------------: | :-----------------------: |
| 📷 摄影  |     `IMG_0001.jpg`       |  `2025-三亚旅拍-001.jpg`  |
| 🎬 视频  |     `DJI_0001.MP4`       |  `项目A-航拍-001.MP4`     |
| 👨‍💻 开发 |   `old-component.js`     |    `component-v2.ts`     |
| 🧪 测试  |     `output.log`         |    `test_001.log`        |
| 📄 合同  |    `扫描0001.pdf`         | `2025-XX公司-采购合同.pdf` |
| 🎵 音乐  |    `Track01.mp3`         |  `周杰伦-晴天.mp3`       |
| 📚 电子书 |      `001.pdf`           | `《三体》-刘慈欣.pdf`     |
| 🏠 日常  | `微信图片_20250101.jpg`   | `2025-01-01-聚会.jpg`    |
| 🧹 运维  | `server.log.2025-01-01`  | `2025-01-01-server.log`  |
